...
function RouteComponent() {
  ...
  return (
    <section className="flex flex-col gap-3 border border-blue-500 w-full px-4">
      ...
      <Card>
        <CardHeader>
          ...
          <CardAction>
            <Button className="cursor-pointer" onClick={handleCreateStory}>
              Publish
            </Button>
          </CardAction>
        </CardHeader>
        <CardContent>
          <div className="w-full border border-red-500 flex flex-col sm:flex-row gap-3">
